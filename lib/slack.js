...
var chatClient = require('./twitch_chat');
...
slack.on('message', function(message) {
    ...
    switch (cmd) {
        case 'channels':
            ...
            var formattedChannels = chatClient.channels
        ...
        case 'online':
            ...
            var requestPromises = [];
            var sortedChannels = chatClient.channels.slice(0).sort();
            ...
            Q.all(requestPromises)
                ...
                .catch(function (error) {
                    var msg = 'There was an error checking one or more of the channels, ' +
